...
const whyItems = [
  ...
  'security and automation built together',
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
          <div className="bg-white border border-gray-200 rounded-2xl p-8">
            ...
            <p className="text-gray-600 mb-6">
              We focus on practical DevSecOps improvements that reduce risk and improve delivery speed for small engineering teams.
            </p>
          ...
          <div className="bg-white border border-gray-200 rounded-2xl p-8">
            <h3 className="text-2xl font-bold text-gray-900 mb-4">What engagement outputs can include</h3>
            <div className="space-y-3">
              {outputs.map((item) => (
                <div key={item} className="flex items-start gap-3">
