    ...
    <section id="final-cta" className="py-20 bg-gradient-to-r from-gray-900 to-blue-900 text-white">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="max-w-4xl mx-auto text-center">
          <h2 className="text-3xl sm:text-4xl font-bold mb-4">Need a stronger DevSecOps foundation?</h2>
          <p className="text-lg text-blue-100 mb-8">
            Whether you need a cloud review, pipeline improvements, Kubernetes hardening, or infrastructure standardization, GAX Global can help you move faster with less risk.
          </p>
